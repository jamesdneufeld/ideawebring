function t(t) {
  ...
  function m(t) {
    ((l = window.innerWidth),
      (a = window.innerHeight),
      h
        ? ((e.width = c.clientWidth), (e.height = c.clientHeight))
    ...
    (!(function () {
      ...
      for (let t = 1; t < 7; t++) {
        ...
        ((d[t].velocity.x += 0.01 * c.X),
          ...
          Math.abs(d[t].velocity.x) < 0.1 &&
            Math.abs(d[t].velocity.y) < 0.1 &&
            Math.abs(c.X) < 0.1 &&
            Math.abs(c.Y) < 0.1 &&
            ((d[t].velocity.x = 0), (d[t].velocity.y = 0)),
          (d[t].position.x += d[t].velocity.x),
          (d[t].position.y += d[t].velocity.y),
          (o = e.clientHeight),
          (s = e.clientWidth),
          d[t].position.y >= o - 11 - 1 &&
            (d[t].velocity.y > 0 && (d[t].velocity.y = 0.7 * -d[t].velocity.y),
            (d[t].position.y = o - 11 - 1)),
          d[t].position.x >= s - 11 &&
            (d[t].velocity.x > 0 && (d[t].velocity.x = 0.7 * -d[t].velocity.x),
...
function e(t) {
  ...
  function g(t) {
    ((o = window.innerWidth),
      (s = window.innerHeight),
      n
        ? ((r.width = i.clientWidth), (r.height = i.clientHeight))
...
function i(t) {
  ...
  function E(t) {
    ((a = window.innerWidth),
      (r = window.innerHeight),
      e
        ? ((s.width = n.clientWidth), (s.height = n.clientHeight))
  ...
  function L(t) {
    ...
    C(d.x, d.y, v[Math.floor(Math.random() * i.length)]);
  }
  function C(t, e, n) {
    u.push(new R(t, e, n));
  }
    ...
    ((this.rotationSign = Math.random() < 0.5 ? -1 : 1),
      ...
      (this.update = function (t) {
        ...
        const e = p(this.age, this.initialLifeSpan),
          n =
            0.0174533 * (this.rotationSign * y(this.age, this.initialLifeSpan));
        (t.translate(this.position.x, this.position.y),
          t.rotate(n),
          t.drawImage(
            this.canv,
...
function o(t) {
  ...
  function y(t) {
    ...
    if (!1 === A) {
      A = !0;
      for (let t = 0; t < r; t++)
        ((e = l.x), (n = l.y), (i = m), a.push(new x(e, n, i)));
    }
    var e, n, i;
  }
  function v() {
...
function c(t) {
  ...
  function f(t) {
    ((o = window.innerWidth),
      (s = window.innerHeight),
      n
        ? ((d.width = i.clientWidth), (d.height = i.clientHeight))
...
function l(t) {
    ...
    ((c = document.createElement("canvas")),
      ...
      e
        ? ((c.style.position = "absolute"),
          ...
          (c.height = n.clientHeight))
        : ((c.style.position = "fixed"),
          document.body.appendChild(c),
          (c.width = r),
          (c.height = d)),
      n.addEventListener("mousemove", E),
      n.addEventListener("touchmove", y, { passive: !0 }),
      n.addEventListener("touchstart", y, { passive: !0 }),
      window.addEventListener("resize", p),
      L());
  }
  function p(t) {
    ((r = window.innerWidth),
      (d = window.innerHeight),
      e
        ? ((c.width = n.clientWidth), (c.height = n.clientHeight))
        : ((c.width = r), (c.height = d)));
  }
  function y(t) {
    if (t.touches.length > 0)
      for (let e = 0; e < t.touches.length; e++)
        M(t.touches[e].clientX, t.touches[e].clientY, m);
  }
  g.onchange = () => {
    g.matches ? C() : f();
  };
  let v = () => Math.floor(Math.random() * (s - o + 1)) + o,
    w = Date.now(),
    x = v();
  function E(t) {
    if (i) {
    ...
    if (e) {
      const e = n.getBoundingClientRect();
      ((u.x = t.clientX - e.left), (u.y = t.clientY - e.top));
    } else ((u.x = t.clientX), (u.y = t.clientY));
    M(u.x, u.y, m);
  }
  function M(t, e, n) {
    A.push(new B(t, e, n));
  ...
  function L() {
    (!(function () {
      if (0 != A.length) {
        l.clearRect(0, 0, r, d);
        for (let t = 0; t < A.length; t++) A[t].update(l);
        for (let t = A.length - 1; t >= 0; t--)
          A[t].lifeSpan < 0 && A.splice(t, 1);
        0 == A.length && l.clearRect(0, 0, r, d);
      }
    })(),
...
function a(t) {
  ...
  function p(t) {
    ...
    if (!1 === A) {
      A = !0;
      for (let t = 0; t < r; t++)
        ((e = l.x), (n = l.y), void 0, a.push(new w(e, n)));
    }
    var e, n;
  }
  function y() {
    (!(function () {
      ...
      (a.forEach(function (n, o, s) {
        ...
        ((n.position.x = e),
          (n.position.y = i),
          t.push({ x: e, y: i }),
          (e += 0.4 * (h.position.x - n.position.x)),
          (i += 0.4 * (h.position.y - n.position.y)));
      }),
        d.forEach((e, i) => {
          (n.beginPath(),
            (n.strokeStyle = e),
...
function r(t) {
  ...
  function J() {
    ...
    for (let t = 0; t < L.length; t++) X[t] = { color: u, value: L[t] };
    for (let t = 0; t < C.length; t++) I[t] = { color: d, value: C[t] };
  ...
  function k() {
    (!(function () {
      ((W[0] = Math.round((b[0] += (l.y - b[0]) * m))),
        (H[0] = Math.round((Y[0] += (l.x - Y[0]) * m))));
      for (let t = 1; t < z; t++)
        ((W[t] = Math.round((b[t] += (W[t - 1] - b[t]) * m))),
          (H[t] = Math.round((Y[t] += (H[t - 1] - Y[t]) * m))),
          b[t - 1] >= c - 80 && (b[t - 1] = c - 80),
...
function d(t) {
  let e,
    ...
    p = { x: g / 2, y: g / 2 };
  ((m = Array.from(c).map((t) => ({ letter: t, x: g / 2, y: g / 2 }))),
    t?.size);
  ...
  function w(t) {
    ((g = window.innerWidth),
      (f = window.innerHeight),
      s
        ? ((e.width = h.clientWidth), (e.height = h.clientHeight))
